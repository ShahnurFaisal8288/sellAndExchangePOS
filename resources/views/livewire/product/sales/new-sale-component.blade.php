                ...
                <div class="card shadow-sm rounded-4 border-0 bg-body">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" step="0.01" wire:model.live.debounce.500ms="discount" class="form-control bg-body text-body border-secondary border-opacity-25">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" min="0" step="0.01" wire:model.live.debounce.500ms="paidAmount" class="form-control fw-bold bg-body text-body border-secondary border-opacity-25 font-monospace">
                        </div>
