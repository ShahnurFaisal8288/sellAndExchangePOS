<div>
    <div class="card card-primary card-outline">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                {{-- <div class="col-md-6">
                    ...
                    <div class="form-text">Manually adjusting this won't create a purchase or IMEI record.</div>
                </div> --}}
                <div class="col-md-6">
        ...
        <div class="card-footer d-flex justify-content-end gap-2">
            ...
            <button type="button" wire:click="update" class="btn btn-primary" wire:loading.attr="disabled" wire:target="update">
